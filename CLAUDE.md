...
- Build boundary: NEVER `assemble*|install*|connected*|build apk|run`. Human builds in Android Studio. Lane ends at `testDebugUnitTest` + `lintDebug` + `tools/verify_project.py`.
