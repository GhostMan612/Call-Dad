...
- G3 peer host: GREEN same build (compile + unit + lint). Device leg PENDING: assemble + install + `WebRTC:D` sequence (BLU View 5 B160V/sdk34 on adb `7040016025040287` as seen from executor lane; Moto G still the truth device for sign-off).
